...
e.server;
0==n.Uploader.support("html5")&&e.compress&&(e.compress.quality=70),e.url.indexOf("cgi-bin/filetransfer?")>=0&&e.url.indexOf("action=upload_material")>0&&(e.compress.afterCompressSizeLimit=5242880,
...
tmpFileUrl:_(p+"/cgi-bin/filetransfer?action=preview"),
mediaFileUrl:_(p+"/cgi-bin/filetransfer?action=bizmedia"),
multimediaFileUrl:_(p+"/cgi-bin/filetransfer?action=multimedia")
};
