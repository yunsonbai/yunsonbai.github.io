...
function o(t,e){
var i=e;
for(var o in e)i[o]=((e[o]||"")+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");
return t.format(i);
}
function n(t,e){
...
init:function(){
t.find(".js_editorTip").html(e.editorTipsTpl?a(e.editorTipsTpl,{
...
change:function(){
var o=i.getContent(),n=o;
i.opt.showLinkAndWeapp&&(o=o.replace(/<a\s+\w[^>]*>(.*?)<\/a>/g,"$1"));
var r=e.wordlimit-o.length,s=t.find(".js_editorArea"),d=t.find(".js_editorTip");
s.attr("placeholder")&&(n?s.removeClass(w):s.addClass(w)),d.html(e.editorTipsTpl?a(e.editorTipsTpl,{
wordlimit:e.wordlimit,
curCount:o.length
...
_initEvent:function(){
var t,e,i=this,o=this,r=$(".js_switch",this.opt.$toolbar||this.selector$),s=$(".js_editorArea",this.selector$),d=this.emotion,p=this.wysiwyg,l=window.UE&&window.UE.dom&&window.UE.dom.domUtils,m=$("#js_undo",this.opt.$toolbar||this.selector$),u=$("#js_redo",this.opt.$toolbar||this.selector$),h=$("#js_link",this.opt.$toolbar||this.selector$),g=$("#js_weapp",this.opt.$toolbar||this.selector$),w=$("#js_unlink",this.opt.$toolbar||this.selector$);
o.onToolHover(r,"表情"),d.click(function(t){
return o.opt.hideEmotion?!1:(p.insertHTML(d.getEmotionHTML(t)),o.saveContent&&o.saveContent(),
d.hide(),!1);
}),d.hide(),r.click(function(){
return o.opt.hideEmotion?!1:void($(this).parents(".js_editor").hasClass("disabled")||(n(r,d.selector$),
d.show()));
}),$(document).on("click","*",function(t){
if(!o.opt.hideEmotion){
var i=$(t.target),n=i.filter(".js_switch"),a=i.filter(".js_emotion_i"),r=i.parents(".js_switch"),s=i.filter(".emotions_item");
n.length||a.length||s.length||r.length||d.hide(),o.opt.showLinkAndWeapp&&e&&e.hide();
}
}),o.onToolHover(h,"超链接"),h.click(function(){
if(!i.opt.showLinkAndWeapp)return!1;
var t=i.wysiwyg.getSelectionRange(),e=s.find(t.startContainer).length>0||$(t.startContainer).hasClass("js_editorArea"),n=s.find(t.endContainer).length>0||$(t.endContainer).hasClass("js_editorArea");
e&&n||(i.wysiwyg.focus(),i.wysiwyg.setCursorToEnd(),t=i.wysiwyg.getSelectionRange());
var a="";
a=l&&(a=l.findParentByTagName(t.startContainer,"a",!0))?a.text:i.wysiwyg.getSelectionText(),
...
"undefined"!=typeof e&&(o.__insertLink(e,t),o.saveContent&&o.saveContent());
});
}),o.onToolHover(g,"小程序"),g.click(function(){
if(!i.opt.showLinkAndWeapp)return!1;
var t=i.wysiwyg.getSelectionRange(),e=s.find(t.startContainer).length>0||$(t.startContainer).hasClass("js_editorArea"),n=s.find(t.endContainer).length>0||$(t.endContainer).hasClass("js_editorArea");
e&&n||(i.wysiwyg.focus(),i.wysiwyg.setCursorToEnd(),t=i.wysiwyg.getSelectionRange());
...
"undefined"!=typeof e&&(o.__insertWeapp(e,t,d),o.saveContent&&o.saveContent());
});
}),this.opt.$toolbar&&!function(){
var n=function(){
return o.opt.showLinkAndWeapp?void(t&&(t.data("miniprogramAppid")?g.click():h.click())):!1;
},r=function(){
return o.opt.showLinkAndWeapp?void(t&&($(document.createTextNode(t.text())).insertBefore(t),
t.remove(),e&&e.hide(),w.find("#js_text_editor_tool_unlink").addClass("edui-state-disabled"),
o.saveContent())):!1;
},d=function(){
var i=o.wysiwyg.getSelectionRange(),n=s.find(i.startContainer).length>0||$(i.startContainer).hasClass("js_editorArea"),r=s.find(i.endContainer).length>0||$(i.endContainer).hasClass("js_editorArea");
if(n&&r&&l&&(t=l.findParentByTagName(i.startContainer,"a",!0))){
if(t=$(t),e){
e.show();
...
o.undoManager.hasUndo?m.find("#js_text_editor_tool_undo").removeClass("edui-state-disabled"):m.find("#js_text_editor_tool_undo").addClass("edui-state-disabled"),
o.undoManager.hasRedo?u.find("#js_text_editor_tool_redo").removeClass("edui-state-disabled"):u.find("#js_text_editor_tool_redo").addClass("edui-state-disabled");
};
i.opt.editorLinkPopupTpl&&(e=$(i.opt.editorLinkPopupTpl),e.hide(),e.find(".js_text_editor_link_edit").click(n),
e.find(".js_text_editor_link_delete").click(r),$(document.body).append(e)),o.saveContent=function(){
o.undoManager.save(o.getContent()),p();
};
var c=void 0,f=void 0;
$(document).on("selectionchange",function(){
return o.opt.showLinkAndWeapp?(e&&e.hide(),c&&clearTimeout(c),void(c=setTimeout(d,300))):!1;
}),o.selector$.on("keyup",function(){
f&&clearTimeout(f),f=setTimeout(function(){
return o.saveContent();
},300);
}),o.onToolHover(w,"取消超链接"),w.click(r),o.onToolHover(m,"撤销"),m.click(function(){
o.undoManager.hasUndo&&(o.setContent(o.undoManager.undo()),o.wysiwyg.setCursorToEnd()),
p();
}),o.onToolHover(u,"重做"),u.click(function(){
o.undoManager.hasRedo&&(o.setContent(o.undoManager.redo()),o.wysiwyg.setCursorToEnd()),
p();
}),o.undoManager.onUndump(function(){
setTimeout(function(){
return o.saveContent();
}),p();
});
}(),this.selector$.find(".js_editorArea").on("focus",function(){
o.opt.ueditor&&o.opt.ueditor.disableToolbar(),o.opt.onFocus&&o.opt.onFocus.call(o);
}).on("click",function(){
o.opt.formItemsOpt&&o.opt.formItemsOpt.guideWords.readonly&&o.opt.formItemsOpt.guideWords.readonlyTips&&c.err(o.opt.formItemsOpt.guideWords.readonlyTips);
}).on("blur",function(){
o.opt.onBlur&&o.opt.onBlur.call(o);
});
},
onToolHover:function(e,i){
var o=this,n=$(document.body).find(".tooltip");
n.length||(n=$(a(t("tpl/tooltip.html.js"),{
content:""
})).hide(),$(document.body).append(n)),e.mouseenter(function(){
o.opt.showLinkAndWeapp&&(e.children(".edui-default").hasClass("edui-state-disabled")||e.children(".edui-default").addClass("edui-state-hover"),
n.show(),n.children(".tooltip_inner").text(i),n.css("top",e.offset().top-n.height()-6).css("left",e.offset().left-(n.width()-e.width())/2));
}),e.mouseleave(function(){
o.opt.showLinkAndWeapp&&(e.children(".edui-default").removeClass("edui-state-hover"),
n.hide());
});
},
...
},o=void 0,n=0;n<t.length;n++)if(n%4===1){
o=!1;
var a=e(t[n],"href");
i(a)&&(o=!0);
var r='<a target="_blank" href="'+(o?a:"javascript:void 0")+'"',s=e(t[n],"data-miniprogram-appid");
if(s)r+=' class="weapp_text_link" data-miniprogram-type="text" data-miniprogram-appid="'+s+'" data-miniprogram-path="'+(e(t[n],"data-miniprogram-path")||"")+'" data-miniprogram-nickname="'+(e(t[n],"data-miniprogram-nickname")||"")+'" data-miniprogram-servicetype="'+(e(t[n],"data-miniprogram-servicetype")||"0")+'"',
o=!0;else if(o){
var d=e(t[n],"data-itemshowtype");
d&&(r+=' data-itemshowtype="'+d+'"');
}
t[n]=o?r+">":"";
}else n%4===3?!o&&(t[n]=""):t[n]=t[n].replace(/<.*?>/g,"");
return t.join("");
},
...
var o=t.wysiwyg.getSelectionRange();
o.collapsed||o.deleteContents(),t.wysiwyg.insertHTML(i);
});
},
...
i=o(i,n),console.log("execCommand",i),this.wysiwyg.insertHTML(i);
},
...
this.wysiwyg.insertWeapp(o,e,i);
},
