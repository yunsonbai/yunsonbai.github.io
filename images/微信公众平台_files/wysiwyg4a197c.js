...
"use strict";
for(var i=/msie/.test(navigator.userAgent.toLowerCase()),a="Wysiwyg",o=e("common/wx/richEditor/editorRange.js"),r="​",s=new RegExp(r,"g"),l=e("common/qq/Class.js"),d=e("biz_common/utils/emoji_data.js"),c='<img src="/mpres/zh_CN/htmledition/comm_htmledition/images/pic/common/pic_blank.gif" class="icon_emotion_single #style#" alt="mo-#name#"></a>',u={},m=0,h=d.length;h>m;m++){
var f=d[m];
f.cn&&!u[f.cn]&&(u[f.cn]={
index:m
}),f.hk&&!u[f.hk]&&(u[f.hk]={
...
if(n(e,"backspace")){
"<br>"==$.trim(t._editArea$.html()).replace(s,"")&&t._editArea$.html(r);
...
var u='<br/><img style="width:1px;height:1px;"></img>',m=l.createContextualFragment(u),h=m.lastChild;
l.deleteContents(),l.insertNode(m),l.setEndAfter(h),l.setStartAfter(h);
var a=o.getSelection();
a.removeAllRanges(),a.addRange(l),document.execCommand("Delete",!1,null);
...
n||p||t._editArea$.html(r),t._saveRang(),t.keyup&&t.keyup(e),t.save();
},
...
var a=n.createContextualFragment(e),r=a.lastChild;
n.deleteContents(),n.insertNode(a),n.setEndAfter(r),n.setStartAfter(r);
...
switch(r.nodeType){
case 1:
if("BR"!==r.nodeName.toUpperCase()){
var s,l=!1;
if((s=e&&e(r))||(s=r.textContent||r.innerText||"",l=!0),s){
var d=l?document.createTextNode(s):s;
!t&&(t=d),i.replaceChild(d,r);
}else i.removeChild(r);
}
break;
...
return i=i.replace(s,""),t.val="function"==typeof n?n(i,e):i,this.val;
},
setContent:function(e,t){
if(this.clear(),e=e||r,this._editArea$.html(e),!t)if("function"==typeof this.textFilter){
...
clear:function(){
this.val="",this._editArea$.html(r);
},
...
this.optimize(t=t.adjustmentBoundary());
var n=window.UE.browser,i=window.UE.dom.domUtils,a=window.UE.utils,o=t.startContainer,r=t.cloneRange();
if(1==o.nodeType&&(o=o.childNodes[t.startOffset],o&&1==o.nodeType&&"A"==o.tagName&&/^(?:https?|ftp|file)\s*:\s*\/\//.test(o[n.ie?"innerText":"textContent"])&&(o[n.ie?"innerText":"textContent"]=a.html(e.textValue||e.href))),
r.collapsed||(t.removeInlineStyle("a"),r=t.cloneRange()),r.collapsed){
var s=document.createElement("a"),l="";
e.textValue?(l=g(a.html(e.textValue).replace(/\n/g,"<br>")),delete e.textValue):l=a.html(e.href),
i.setAttributes(s,e),o=i.findParentByTagName(r.startContainer,"a",!0),o&&i.isInNodeEndBoundary(r,o)&&t.setStartAfter(o).collapse(!0),
s.innerHTML=l,t.insertNode(s).selectNode(s);
}else t.applyInlineStyle("a",e);
return t.collapse().select(!0),this._saveRang().save(),this;
},
insertWeapp:function(e,t,n){
this.optimize(t=t.adjustmentBoundary());
var i=window.UE.browser,a=window.UE.dom.domUtils,o=window.UE.utils,r=t.startContainer,s=t.cloneRange();
1==r.nodeType&&(r=r.childNodes[t.startOffset],r&&1==r.nodeType&&"A"==r.tagName&&/^(?:https?|ftp|file)\s*:\s*\/\//.test(r[i.ie?"innerText":"textContent"])&&(r[i.ie?"innerText":"textContent"]=o.html(e.textValue||e.href))),
s.collapsed||(n||t.deleteContents(),s=t.cloneRange());
var l=document.createElement("a"),d="";
return e.textValue?(d=g(o.html(e.textValue).replace(/\n/g,"<br>")),delete e.textValue):d=o.html(e.href),
a.setAttributes(l,e),r=a.findParentByTagName(s.startContainer,"a",!0),r&&a.isInNodeEndBoundary(s,r)&&t.setStartAfter(r).collapse(!0),
