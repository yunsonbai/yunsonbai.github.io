...
"use strict";
function t(o){
return u.hasInit?!0:(u.$dom=o.$dom,u.wordlimit=o.wordlimit,u.onFocus=o.onFocus,void(u.onBlur=o.onBlur));
}
function i(o,t){
return u.$dom?(u.myEditor||r(o,t),u.myEditor):null;
}
function r(o,t){
...
onFocus:u.onFocus,
onBlur:u.onBlur
}),void u.$dom.find(".js_editorArea").on("focus",e)):null;
}
function e(){
...
e.server;
n&&0==n.Uploader.support("html5")&&e.compress&&(e.compress.quality=70),e.url.indexOf("cgi-bin/filetransfer?")>=0&&e.url.indexOf("action=upload_material")>0&&(e.compress.afterCompressSizeLimit=5242880,
e.compress.resizeSize=5242880);
try{
a=n.create(e);
}catch(b){
if(!a)return;
