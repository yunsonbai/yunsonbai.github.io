...
function n(e,o,n){
var i,s;
n&&"object"==("undefined"==typeof n?"undefined":_typeof(n))?(i=n.done,s=n.fail):i=n,
...
responseText:o.mock
}),o.mock.url=o.mock.url||o.url,$.mockjax(o.mock)),o.mask&&($.isPlainObject(o.mask)?r.show(o.mask):r.show());
var d=$.ajax(o);
return d.callback=d.done,d.done(function(e){
try{
if(i){
var o=i?i.toString():"",n={
uin:wx.uin||"0",
id:"64430",
key:"0",
url:"",
...
uin:n.uin,
url:n.url||n.location,
id:138,
msg:encodeURIComponent("ret="+n.ret+"|idkey="+n.id+":"+n.key)
})),"undefined"!=typeof window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs)){
var r=this.url;
if(-1!==this.url.indexOf("?")){
r=this.url.substr(0,this.url.indexOf("?"));
var s=new t(this.url);
"String"==typeof s.get("action")&&(r+="?action="+s.get("action"));
}
window.WX_BJ_REPORT.BadJs.report(r,"ret="+e.base_resp.ret,{
mid:window.PAGE_MID,
view:"web_retcode"
});
}
...
s&&s(n),a.error(n,o,e),m.trigger("xhrError",e,n,r,o);
}).always(function(){
o.mask&&r.hide();
}),d;
}
var r=e("common/qq/mask.js"),t=e("common/qq/url.js"),i=e("common/wx/dialog.js"),s=e("common/wx/Tips.js"),a=e("common/wx/cgiReport.js");
...
o.show=function(e,o){
var n=d[e.base_resp.ret]||"系统繁忙，请稍后尝试！";
return 0==e.base_resp.ret?void(o?i.show({
type:"succ",
msg:"系统提示|"+n
}):s.suc(n)):void(o?i.show("系统错误|"+n):s.err(n));
...
var n,r=d[o.ret];
r?o.showMsg&&s.err(r):(n=new Image,n.src="/mp/unknow_ret_report?uin={uin}&id={id}&key={key}&url={url}&location={location}&ret={ret}&method=get&action=report".format(o),
